...
export default async function NotificationsPage() {
  ...
  return <main className="notifications-page"><header className="page-header"><Link href="/profile" className="page-back-btn" aria-label="Back to Profile">←</Link><div><p className="page-kicker">Stay connected</p><h1 className="page-title">Notifications</h1></div></header>
